#define CRITICAL_DISPLACEMENT 50
#define RC 1
#define LC 2
#define UC 3
#define DC 4
...
//	cout << lasty << " " << cury << endl;
	...
	if( curx - lastx > CRITICAL_DISPLACEMENT && clicked != RC )
		// PRESS RIGHT ARROW
	{
		hold = true ;
		clicked = RC ;
...
//		cout << "DOWN CLICKED \n" ;
	...
	else if (lastx - curx > CRITICAL_DISPLACEMENT && clicked != LC)
		// PRESS LEFT KEY
	{		
//		cout  << "LEFT CLICKED \n" ;
		hold = true ;
...
//	return  ;
	...
	if ( ((abs(rightx-recX))>8&&(abs(righty-recY))<50) || ((abs(rightx-recX))<50&&(abs(righty-recY))>8) )
		cnt ++ ;
	else
